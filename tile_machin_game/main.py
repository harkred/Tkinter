...
button1 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button1, value1))
values.remove(value1)

value2 = random.choice(values)
button2 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button2, value2))
values.remove(value2)

value3 = random.choice(values)
button3 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button3, value3))
values.remove(value3)

value4 = random.choice(values)
button4 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button4, value4))
values.remove(value4)

value5 = random.choice(values)
button5 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button5, value5))
values.remove(value5)

value6 = random.choice(values)
button6 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button6, value6))
values.remove(value6)

value7 = random.choice(values)
button7 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button7, value7))
values.remove(value7)

value8 = random.choice(values)
button8 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button8, value8))
values.remove(value8)

value9 = random.choice(values)
button9 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button9, value9))
values.remove(value9)

value10 = random.choice(values)
button10 = ttk.Button(main_frame, text='?', command=lambda:tile_matcher(button10, value10))
